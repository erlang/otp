...
enter_file2(NewF, Pname, From, St0, AtLocation) ->
    ...
    #epp{macs = Ms0,
         ...
         features = Ftrs} = St0,
    SourceName = case St0#epp.deterministic of
                     true -> filename:basename(Pname);
                     false -> Pname
                 end,
    Ms = Ms0#{'FILE':={none,[{string,Anno,SourceName}]}},
...
leave_file(From, St) ->
	...
	[] ->
		...
		[OldSt|Sts] ->
            ...
            SourceName = case St#epp.deterministic of
...
scan_file1([{'(',_Alp},{string,_As,Name},{',',_Ac},{integer,_Ai,Ln},{')',_Arp},
    ...
    Ms0 = St#epp.macs,
    Ms = Ms0#{'FILE':={none,[{string,line1(),SourceName}]}},
    Locf = loc(Tf),
