...
lc_quals([{zip,_Anno,Gens0} | Qs], Vt0, Uvt0, St0) ->
    {Gens1, St1} = are_all_generators(Gens0, [], St0),
...
are_all_generators([{generate,_,_,_}=Q|Qs], Acc, St) ->
    are_all_generators(Qs, [Q|Acc], St);
are_all_generators([{generate_strict,_,_,_}=Q|Qs], Acc, St) ->
    are_all_generators(Qs, [Q|Acc], St);
are_all_generators([{b_generate,_,_,_}=Q|Qs], Acc, St) ->
    are_all_generators(Qs, [Q|Acc], St);
are_all_generators([{b_generate_strict,_,_,_}=Q|Qs], Acc, St) ->
    are_all_generators(Qs, [Q|Acc], St);
are_all_generators([{m_generate,_,_,_}=Q|Qs], Acc, St) ->
    are_all_generators(Qs, [Q|Acc], St);
are_all_generators([{m_generate_strict,_,_,_}=Q|Qs], Acc, St) ->
    are_all_generators(Qs, [Q|Acc], St);
are_all_generators([Q|Qs], Acc, St0) ->
    Anno1 = element(2, Q),
    St1 = add_error(Anno1, illegal_zip_generator, St0),
    are_all_generators(Qs, Acc, St1);
are_all_generators([], Acc, St) ->
    {reverse(Acc), St}.
