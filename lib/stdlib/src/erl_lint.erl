...
format_error_1(deprecated_catch) ->
    ~"""
     'catch ...' is deprecated and will be removed in a future version
     of Erlang/OTP; please use 'try ... catch ... end' instead.
     Compile directive 'nowarn_deprecated_catch' can be used to suppress
     warnings in selected modules for the time being.
     """;
