...
lc_expr -> map_field_exact '<:-' expr : {m_generate_ns,?anno('$2'),'$1','$3'}.
lc_expr -> expr '<-' expr : {generate,?anno('$2'),'$1','$3'}.
lc_expr -> expr '<:-' expr : {generate_ns,?anno('$2'),'$1','$3'}.
lc_expr -> binary '<=' expr : {b_generate,?anno('$2'),'$1','$3'}.
lc_expr -> binary '<:=' expr : {b_generate_ns,?anno('$2'),'$1','$3'}.
...
-type af_generator() :: {'generate', anno(), af_pattern(), abstract_expr()}
                      | {'generate_ns', anno(), af_pattern(), abstract_expr()}
                      | {'m_generate', anno(), af_assoc_exact(af_pattern()), abstract_expr()}
                      | {'m_generate_ns', anno(), af_assoc_exact(af_pattern()), abstract_expr()}
                      | {'b_generate', anno(), af_pattern(), abstract_expr()}
                      | {'b_generate_ns', anno(), af_pattern(), abstract_expr()}.
