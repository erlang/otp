...
Example:
```erlang
1> io_ansi:cursor_move(-5, 0).   %% Up 5 lines
<<"\e[5A">>
2> io_ansi:cursor_move(0, 10).   %% Right 10 columns
<<"\e[10C">>
3> io_ansi:cursor_move(3, -2).   %% Down 3, left 2
<<"\e[3B\e[2D">>
4> io_ansi:cursor_move(0, 0).    %% No movement
<<>>
```
""".
...
parse_cursor_position("\e[" ++ Rest) ->
    case string:split(Rest, ";", [global]) of
        [RowBin, ColBinWithR] ->
