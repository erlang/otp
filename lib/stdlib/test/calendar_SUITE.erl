...
rfc3339(Config) when is_list(Config) ->
    ...
    %% GH-9279
    "1969-12-31T23:59:58.750+00:00" = do_format(-1250, [{offset, 0}]++Ms),
    "1969-12-31T23:59:59.000+00:00" = do_format(-1000, [{offset, 0}]++Ms),
    "1969-12-31T23:59:59.250+00:00" = do_format(-750, [{offset, 0}]++Ms),
    "1969-12-31T23:59:59.500+00:00" = do_format(-500, [{offset, 0}]++Ms),
    "1969-12-31T23:59:59.750+00:00" = do_format(-250, [{offset, 0}]++Ms),
    "1970-01-01T00:00:00.000+00:00" = do_format(0, [{offset, 0}]++Ms),
    "1970-01-01T00:00:00.250+00:00" = do_format(250, [{offset, 0}]++Ms),
    "1970-01-01T00:00:00.500+00:00" = do_format(500, [{offset, 0}]++Ms),
    "1970-01-01T00:00:00.750+00:00" = do_format(750, [{offset, 0}]++Ms),
    "1970-01-01T00:00:01.000+00:00" = do_format(1000, [{offset, 0}]++Ms),
    "1970-01-01T00:00:01.250+00:00" = do_format(1250, [{offset, 0}]++Ms),
    ...
    %% GH-9279
    -1250 = do_parse("1969-12-31T23:59:58.75Z", Ms),
    -1000 = do_parse("1969-12-31T23:59:59.0Z", Ms),
    -750 = do_parse("1969-12-31T23:59:59.25Z", Ms),
    -500 = do_parse("1969-12-31T23:59:59.5Z", Ms),
    -250 = do_parse("1969-12-31T23:59:59.75Z", Ms),
    0 = do_parse("1970-01-01T00:00:00.0Z", Ms),
    250 = do_parse("1970-01-01T00:00:00.25Z", Ms),
    500 = do_parse("1970-01-01T00:00:00.5Z", Ms),
    750 = do_parse("1970-01-01T00:00:00.75Z", Ms),
    1000 = do_parse("1970-01-01T00:00:01.0Z", Ms),
    1250 = do_parse("1970-01-01T00:00:01.25Z", Ms),
