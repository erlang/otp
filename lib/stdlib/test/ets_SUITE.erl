...
memory_do(Opts) ->
    ...
    XR1 = case mem_mode(T1) of
	    {normal,_} ->     {13836,13046,14046,14052}; %{13862,13072,13072,13078};
	    {compressed,4} -> {11041,10251,11251,11252}; %{11067,10277,10277,10278};
	    {compressed,8} -> {10050,9260,10260,10260} %{10076,9286,9286,9286}
	  end,
    ...
    XR2 = case mem_mode(T1) of
	    {normal,_} ->     {13826,13037,14026,14032}; %{13852,13063,13054,13060};
	    {compressed,4} -> {11031,10242,11231,11232}; %{11057,10268,10259,10260};
	    {compressed,8} -> {10040,9251,10240,10240}     %10066,9277,9268,9268}
	  end,
    ...
    XR3 = case mem_mode(T1) of
		{normal,_} ->     {13816,13028,14006,14012}; %{13842,13054,13036,13042};
		{compressed,4} -> {11021,10233,11211,11212}; %{11047,10259,10241,10242};
		{compressed,8} -> {10030,9242,10220,10220} %{10056,9268,9250,9250}
	  end,
