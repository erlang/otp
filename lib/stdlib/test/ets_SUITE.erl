...
-export([t_repair_continuation_do/1, t_bucket_disappears_do/1,
	 ...
	 lookup_order_do/1, cont_order_do/1, lookup_element_mult_do/1, delete_tab_do/1,
	 delete_elem_do/1, match_delete_do/1, match_delete3_do/1, firstnext_do/1,
...
match2_do(Opts) ->
    ...
    [[key2],[key2_wannabe]] = ets:match(Tab, {value2_1, '$2'}),
