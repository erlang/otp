...
parse_f_sigil(Config) when is_list(Config) ->
    {ok,
     [{match,
      ...
      {bin,
       {3,1},
       [{bin_element,3,{string,3,"f"},default,[utf8]},
        {bin_element,3,{block,3,[{var,3,'OO'}]},default,[binary]},
        {bin_element,3,{string,3,"b"},default,[utf8]},
        {bin_element,3,
         {block,3,
          [{match,3,
            {var,3,'A'},
            {bin,3,
             [{bin_element,3,{string,3,"a"},default,[utf8]}]}},
           {bin,3,
            [{bin_element,3,
              {block,3,[{var,3,'A'}]},
              default,
              [binary]},
             {bin_element,3,{string,3,"r"},default,[utf8]},
             {bin_element,3,
              {block,3,[{var,3,'Baz'}]},
              default,
              [binary]}]}]},
