...
unused_vars_warn_basic(Config) when is_list(Config) ->
    Ts = [{basic1,
           ...
           ">>,
	   [warn_unused_vars],
	   {warnings,[{{1,3},erl_lint,{unused_var,'F'}},
             {{15,24},erl_lint,{unused_var,'Y'}},
             {{22,15},erl_lint,{unused_var,'N'}},
             {{23,31},erl_lint,{shadowed_var,'N','fun'}},
             {{28,26},erl_lint,{unused_var,'B'}},
             {{29,26},erl_lint,{unused_var,'B'}}]}}],
    ?line [] = run(Config, Ts),
    ok.
...
unused_vars_warn_lc(Config) when is_list(Config) ->
    Ts = [{lc1, 
     ...
     %  {{24,37},erl_lint,{exported_var,'X',{'case',{8,19}}}},
             {{24,35},erl_lint,{unused_var,'U'}},
     %  {{26,37},erl_lint,{exported_var,'X',{'case',{8,19}}}},
     ...
     %  {{21,29},erl_lint,{exported_var,'X',{'case',{9,5}}}},
     ...
     %       ,{{21,34},erl_lint,{exported_var,'X',{'case',{8,19}}}}
     %       ,{{21,27},erl_lint,{shadowed_var,'U',generate}}
            ]}},
...
unused_vars_warn_fun(Config) when is_list(Config) ->
    Ts = [{fun1,
           ...
           ">>,
           [warn_unused_vars],
           {warnings,[{{1,4},erl_lint,{unused_var,'A'}},
...
unused_import(Config) when is_list(Config) ->
    Ts = [{imp1,
	   <<"-import(lists, [map/2,foldl/3]).
           ...
           ">>,
	   [warn_unused_import],
	   {warnings,[{{1,2},erl_lint,{unused_import,{{foldl,3},lists}}}]}}],
    ?line [] = run(Config, Ts),
    ok.
    ...
    Ts = [{unsafe_try1,
	  ...
	  {unsafe_try2,
	   <<"foo1a() ->
           ...
           ">>,
	   [],
	   {errors,[{{9,25},erl_lint,{unsafe_var,'Ra',{'try',{3,19}}}},
                    {{9,22},erl_lint,{unsafe_var,'Rc',{'try',{3,19}}}},
	  ...
	  {unsafe_try3,
	   ...
	   {errors,[{{5,41},erl_lint,{unsafe_var,'R',{'try',{3,19}}}},
		    ...
		    {{11,33},erl_lint,{unsafe_var,'R',{'try',{10,19}}}},
	  ...
	  {unsafe_try4,
	   <<"foo1(X) ->
           ...
           ">>,
	   [],
	   {errors,[{{4,33},erl_lint,{unsafe_var,'R',{'try',{3,19}}}},
		    {{6,43},erl_lint,{unbound_var,'RR'}},
		    {{6,46},erl_lint,{unbound_var,'Ro'}},
		    {{6,41},erl_lint,{unsafe_var,'R',{'try',{3,19}}}},
...
guard(Config) when is_list(Config) ->
    ...
    Ts = [{guard1,
	    ...
	    [{{18,25},erl_lint,{removed,{erlang,is_constant,1},
			   "Removed in R13B"}}]}},
          {guard2,
           <<"-record(apa,{}).
           ...
           ">>,
           [nowarn_obsolete_guard],
	   {error,[{{6,26},erl_lint,illegal_guard_expr},
		   {{6,39},erl_lint,illegal_guard_expr},
		   {{18,26},erl_lint,illegal_guard_expr},
		   {{18,42},erl_lint,illegal_guard_expr}],
	    [{{18,26},erl_lint,{removed,{erlang,is_constant,1},
			   "Removed in R13B"}},
             {{18,42},erl_lint,{removed,{erlang,is_constant,1},
			   "Removed in R13B"}}]}},
          {guard3,
           <<"-record(apa,{}).
    ...
    Ts1 = [{guard5,
            ...
            {error,[{{2,27},erl_lint,illegal_guard_expr},
		    ...
		    {{12,33},erl_lint,illegal_guard_expr},
		    {{14,27},erl_lint,illegal_guard_expr},
		    {{16,27},erl_lint,illegal_guard_expr},
		    {{18,33},erl_lint,illegal_guard_expr},
		    {{20,27},erl_lint,illegal_guard_expr}],
	     [{{8,27},erl_lint,deprecated_tuple_fun},
	      {{14,27},erl_lint,deprecated_tuple_fun},
	      {{20,27},erl_lint,deprecated_tuple_fun},
	      {{28,27},erl_lint,deprecated_tuple_fun}]}},
           {guard6,
...
otp_4988(Config) when is_list(Config) ->
    Ts = [{otp_4988,
           <<"-compile({inline, [{f,3},{f,4},{f,2},{f,a},{1,foo}]}).
             ...
             ">>,
           [],
           {errors,[{{1,2},erl_lint,{bad_inline,{1,foo}}},
                    {{1,2},erl_lint,{bad_inline,{f,3}}},
                    {{1,2},erl_lint,{bad_inline,{f,4}}},
                    {{1,2},erl_lint,{bad_inline,{f,a}}},
...
otp_5276(Config) when is_list(Config) ->
    Ts = [{otp_5276_1,
          <<"-deprecated([{frutt,0,next_version}]).
            ...
            ">>,
           {[]},
           {error,[{{1,2},erl_lint,{bad_deprecated,{frutt,0}}},
            ...
            [{{12,14},erl_lint,{unused_function,{frutt,0}}}]}}],
    ?line [] = run(Config, Ts),
    ok.
...
otp_5338(Config) when is_list(Config) ->
    ...
    Ts = [{otp_5338,
          <<"-record(c, {a = <<X:7/binary-unit:8>>}).
            ...
            ">>,
           [],
           {error,[{{1,19},erl_lint,{unbound_var,'X'}}],
...
otp_5362(Config) when is_list(Config) ->
    Ts = [{otp_5362_1,
          ...
          {[warn_unused_vars, warn_unused_import]},
           {error,[{{5,15},erl_lint,{bad_inline,{inl,7}}},
                   ...
                   {{22,15},erl_lint,{bad_nowarn_unused_function,
                                     {and_not_used,2}}}],
            [{{3,15},erl_lint,{unused_import,{{b,1},'lists.foo'}}},
	  ...
	  %% (OTP-8579) /PaN
	    ...
	    [{{4,25},erl_lint,{deprecated,{erlang,hash,2},{erlang,phash2,2},
			  "in a future release"}}]}},
	   ...
	   {errors,
          ...
          {otp_5362_7,
           ...
           ">>,
           {[nowarn_unused_function]},
           {error,[{{3,16},erl_lint,disallowed_nowarn_bif_clash},
		   {{4,16},erl_lint,disallowed_nowarn_bif_clash},
		   {{4,16},erl_lint,{bad_nowarn_bif_clash,{spawn,2}}}],
            [{{5,16},erl_lint,{bad_nowarn_deprecated_function,{3,hash,-1}}},
             {{5,16},erl_lint,{bad_nowarn_deprecated_function,{erlang,hash,-1}}},
             {{5,16},erl_lint,{bad_nowarn_deprecated_function,
                              {{a,b,c},hash,-1}}}]}
           },
          ...
          {otp_5362_8,
           ...
           {warnings,
            [{{5,25},erl_lint,{deprecated,{erlang,hash,2},{erlang,phash2,2},
			  "in a future release"}}]}},
...
otp_5371(Config) when is_list(Config) ->
    Ts = [{otp_5371_1,
           <<"t(<<A:8>> = <<B:8>>) ->
             ...
             ">>,
	   [],
	   {errors,[{{1,3},erl_lint,illegal_bin_pattern}],[]}},
	  {otp_5371_2,
           <<"x([<<A:8>>] = [<<B:8>>]) ->
                  {A,B}.
              y({a,<<A:8>>} = {b,<<B:8>>}) ->
             ...
             ">>,
	   [],
	   {errors,[{{1,4},erl_lint,illegal_bin_pattern},
...
otp_7227(Config) when is_list(Config) ->
    Ts = [{otp_7227_1,
           <<"t([<<A:8>> = {C,D} = <<B:8>>]) ->
             ...
             ">>,
	   [],
	   {errors,[{{1,22},erl_lint,illegal_bin_pattern}],[]}},
	  {otp_7227_2,
           <<"t([(<<A:8>> = {C,D}) = <<B:8>>]) ->
                  {A,B,C,D}.
             ">>,
	   [],
	   {errors,[{{1,5},erl_lint,illegal_bin_pattern}],[]}},
	  {otp_7227_3,
           <<"t([(<<A:8>> = {C,D}) = (<<B:8>> = <<C:8>>)]) ->
                  {A,B,C,D}.
             ">>,
	   ...
	   {errors,[{{1,25},erl_lint,illegal_bin_pattern},
		    {{1,25},erl_lint,illegal_bin_pattern},
		    {{1,35},erl_lint,illegal_bin_pattern}],[]}},
	  {otp_7227_4,
           <<"t(Val) ->
                  <<A:8>> = <<B:8>> = Val,
                  {A,B}.
...
otp_5878(Config) when is_list(Config) ->
    Ts = [{otp_5878_10,
          <<"-record(rec1, {a = #rec2{}}).
            ...
            ">>,
           [warn_unused_record],
           {error,[{{1,20},erl_lint,{undefined_record,rec2}}],
          ...
          {otp_5878_20,
           <<"-record(r1, {a = begin A = 4, {A,B} end}). % B unbound
             ...
             ">>,
           [warn_unused_record],
           {error,[{{1,34},erl_lint,{unbound_var,'B'}},
                   {{1,24},erl_lint,{variable_in_record_def,'A'}},
                   {{2,38},erl_lint,{variable_in_record_def,'A'}}],
            [{{1,2},erl_lint,{unused_record,r1}}]}},
          ...
          {otp_5878_40,
           <<"-record(r1, {foo = A}). % A unbound
             ...
             ">>,
           [warn_unused_record],
           {errors,[{{1,20},erl_lint,{unbound_var,'A'}}],[]}},
          ...
          {otp_5878_50,
           <<"-record(r1, {a = {A, % A unbound
             ...
             ">>,
           [warn_unused_record],
           {error,[{{1,19},erl_lint,{unbound_var,'A'}},
          ...
          {otp_5878_80,
           <<"-record(r, {a = [X || {A,Y} <- [{1,2},V={3,4}],
             ...
             ">>,
           [warn_unused_record],
           {warnings,[{{1,39},erl_lint,{unused_var,'V'}}]}},
          ...
          {otp_5878_90,
           <<"-record(r, {a = foo()}). % unused
             ...
             ">>,
           [warn_unused_record],
           {error,[{{1,17},erl_lint,{undefined_function,{foo,0}}}],
            [{{1,2},erl_lint,{unused_record,r}}]}},
          ...
          {otp_5878_abstr,
           <<"-module(lint_test, [A, B]).
             ...
             ">>,
           [warn_unused_record],
           {error,[{{3,31},erl_lint,{unbound_var,'A'}},
                   {{3,38},erl_lint,{unbound_var,'THIS'}}],
            [{{10,26},erl_lint,{unused_var,'THIS'}},
             {{10,26},erl_lint,{shadowed_var,'THIS','fun'}}]}},
          ...
          {otp_5878_qlc1,
           <<"-include_lib(\"stdlib/include/qlc.hrl\").
             ...
             ">>,
           [warn_unused_record],
           {error,[{{6,55},qlc,{used_generator_variable,'A'}},
                   {{6,57},qlc,{used_generator_variable,'Y'}},
                   {{6,49},qlc,{used_generator_variable,'Z'}}],
            [{{4,60},erl_lint,{unused_var,'V'}}]}},
          ...
          {otp_5878_ill1,
           <<"-record(r, {a = true}).
             ...
             ">>,
           [warn_unused_record],
           {errors,[{{4,32},erl_lint,{unbound_var,'A'}},
                    {{11,31},erl_lint,illegal_guard_expr},
                    {{13,35},erl_lint,{undefined_field,r3,q}},
                    {{15,34},erl_lint,{undefined_field,r,q}},
                    {{19,41},erl_lint,illegal_guard_expr},
                    {{21,30},erl_lint,{illegal_guard_local_call,{l,0}}}],
            []}},
          ...
          {otp_5878_ill2,
           <<"t() ->
             ...
             ">>,
           [warn_unused_record],
           {errors,[{{2,24},erl_lint,{undefined_function,{x,0}}},
                    {{3,30},erl_lint,illegal_guard_expr},
          ...
          {otp_5878_usage1,
           <<"-record(u1, {a}).
             ...
             ">>,
           [warn_unused_record],
           {warnings,[{{3,16},erl_lint,{unused_record,u3}},
                      {{4,16},erl_lint,{unused_record,u4}}]}},
          ...
          {otp_5878_qlc2,
           <<"-import(qlc, [q/2]).
             ...
             ">>,
           [warn_unused_record],
           {warnings,[{{4,27},erl_lint,{missing_qlc_hrl,1}},
                      {{5,27},erl_lint,{missing_qlc_hrl,2}},
                      {{6,24},erl_lint,{missing_qlc_hrl,2}}]}}
         ],
    ?line [] = run(Config, Ts),
    ...
    ?line {errors,[{{1,1},erl_lint,undefined_module}],[]} =
        run_test2(Config, Ill3, [column, warn_unused_record]),
...
otp_6885(Config) when is_list(Config) ->
    Ts = [{otp_6885,
           <<"t(<<_/binary,I>>) -> I;
             ...
             ">>,
           [],
           {errors,[{{1,14},erl_lint,unsized_binary_not_at_end},
		                {{2,28},erl_lint,unsized_binary_not_at_end},
		                {{3,28},erl_lint,unsized_binary_not_at_end},
		                {{8,21},erl_lint,typed_literal_string},
...
export_all(Config) when is_list(Config) ->
    Ts = [{export_all,
           <<"-module(export_all_module).
             ...
             ">>,
           {[warn_export_all]},
           {warnings,[{{2,16},erl_lint,export_all}]}}
         ],
    ?line [] = run(Config, Ts),
    ok.
...
behaviour_basic(Config) when is_list(Config) ->
    Ts = [{behaviour1,
           <<"-behaviour(application).
             ">>,
           [],
	   {warnings,[{{1,2},erl_lint,{undefined_behaviour_func,{start,2},
                       application}},
		      {{1,2},erl_lint,{undefined_behaviour_func,{stop,1},
                       application}}]}},
...
behaviour_multiple(Config) when is_list(Config) ->
    Ts = [{behaviour1,
	   ...
	   {warnings,[{{1,2},erl_lint,{undefined_behaviour_func,{start,2},
                       application}},
		      {{1,2},erl_lint,{undefined_behaviour_func,{stop,1},application}},
		      {{2,16},erl_lint,{undefined_behaviour_func,{init,1},
                       supervisor}}]}},
	  ...
	  {behaviour3,
           <<"-behaviour(gen_server).
             ...
             ">>,
           [],
	   {warnings,[{{1,2},erl_lint,
		       {undefined_behaviour_func,{code_change,3},gen_server}},
		      {{1,2},erl_lint,
               {undefined_behaviour_func,{init,1},gen_server}},
		      {{1,2},erl_lint,
               {undefined_behaviour_func,{terminate,2},gen_server}},
		      {{2,16},erl_lint,
               {undefined_behaviour_func,{init,1},supervisor}},
		      {{2,16},
		       erl_lint,
		       {conflicting_behaviours,{init,1},supervisor,{1,2},gen_server}}]}},
	  {american_behavior3,
           <<"-behavior(gen_server).
              -behavior(supervisor).
              -export([handle_call/3,handle_cast/2,handle_info/2]).
	  ...
	  {behaviour4,
	   ...
	   {warnings,[{{2,16},
		       erl_lint,
		       {conflicting_behaviours,{init,1},gen_fsm,{1,2},gen_server}},
		      {{3,16},
		       erl_lint,
		       {conflicting_behaviours,{init,1},supervisor,{1,2},gen_server}}]}}
	 ],
...
otp_8051(Config) when is_list(Config) ->
    Ts = [{otp_8051,
           <<"-opaque foo() :: bar().
             ">>,
           [],
           {error,[{{1,18},erl_lint,{undefined_type,{bar,0}}}],
            [{{1,2},erl_lint,{unused_type,{foo,0}}}]}}],
    ?line [] = run(Config, Ts),
    ok.
...
on_load_failing(Config) when is_list(Config) ->
    Ts = [{on_load_1,
	  ...
	  {on_load_4,
	   ...
	   {[]},				%Tuple indicates no 'export_all'.
	   {errors,
	    [{{1,2},erl_lint,{bad_on_load_arity,{foo,1}}}],[]}},
	  ...
	  {on_load_5,
	   ...
	   {[]},				%Tuple indicates no 'export_all'.
	   {errors,
	    [{{1,2},erl_lint,{undefined_on_load,{non_existing,0}}}],[]}}
	 ],
    ?line [] = run(Config, Ts),
    ok.
...
too_many_arguments(Config) when is_list(Config) ->
    Ts = [{too_many_1,
	   ...
	   [],
	   {errors,
	    [{{1,1},erl_lint,{too_many_arguments,256}}],[]}}
	 ],
...
run(Config, Tests) ->
    F = fun({N,P,Ws,E0}, BadL) ->
                E = strip_columns(E0),
                BadL1 = case catch run_test(Config, P, Ws) of
                    E -> 
                        BadL;
                    Bad -> 
			...
			fail()
                ...
                ESorted = sort_warnings(E0),
                case catch run_test(Config, P, add_column_opt(Ws)) of
                    ESorted ->
                        BadL1;
                    Bad2 ->
                        ?t:format("~nTest ~p failed with columns. "
                                  "Expected~n  ~p~n"
                                  "but got~n  ~p~n", [N, ESorted, Bad2]),
                        fail()
                end
        end,
    lists:foldl(F, [], Tests).

strip_columns({warnings, Ws}) ->
    {warnings, strip_columns_2(Ws)};
strip_columns({errors, Es, []}) ->
    {errors, strip_columns_2(Es), []};
strip_columns({error, Es, Ws}) ->
    {error, strip_columns_2(Es), strip_columns_2(Ws)};
strip_columns({errors2, Es1, Es2}) ->
    {errors2, strip_columns_2(Es1), strip_columns_2(Es2)};
strip_columns([]) ->
    [].

strip_columns_2(Ws) ->
    lists:map(fun ({{Line,_Col},erl_lint,{unsafe_var,Var,{Tag,{L2,_C2}}}}) ->
                      {Line, erl_lint,{unsafe_var,Var,{Tag,L2}}};
                  ({{Line,_Col},erl_lint,{exported_var,Var,{Tag,{L2,_C2}}}}) ->
                      {Line,erl_lint,{exported_var,Var,{Tag,L2}}};
                  ({{Line,_Col},erl_lint,
                    {conflicting_behaviours,F,M1,{L2,_C2},M2}}) ->
                      {Line,erl_lint,{conflicting_behaviours,F,M1,L2,M2}};
                  ({{Line,_Col},Mod,Info}) ->
                      {Line,Mod,Info};
                  (W) ->
                      W
...
sort_warnings({warnings, Ws}) ->
    {warnings, lists:keysort(1, Ws)};
sort_warnings({errors, Es, []}) ->
    {errors, lists:keysort(1, Es), []};
sort_warnings({error, Es, Ws}) ->
    {error, lists:keysort(1, Es), lists:keysort(1, Ws)};
sort_warnings({errors2, Es1, Es2}) ->
    {errors2, lists:keysort(1, Es1), lists:keysort(1, Es2)};
sort_warnings([]) ->
    [].
...
run_test(Conf, Test = <<"-module", _/binary>>, Warnings0) ->
    run_test2(Conf, Test, Warnings0);
run_test(Conf, Test0, Warnings0) ->
    Test = list_to_binary(["-module(lint_test). -file(?FILE, 0).\n",
                           Test0]),
    run_test2(Conf, Test, Warnings0).
