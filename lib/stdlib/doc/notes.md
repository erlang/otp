...
- Added functions to `m:unicode` for recognizing whitespace and identifier.
...
- `m:graph` is a new module that is a functional equivalent of the `m:digraph` and `m:digraph_utils` modules.
