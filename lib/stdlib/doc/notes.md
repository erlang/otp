...
- Module `m:re` has been updated to use PCRE2, which is mostly backward compatible with PCRE.
  ...
  *** POTENTIAL INCOMPATIBILITY ***
  ...
  Own Id: OTP-19431 Aux Id: [PR-9299]
...
- A new event time-out has been implemented in `gen_server`, that behaves more like the one in `gen_statem`.  Documentation and test cases are planned for a later patch.

  Own Id: OTP-19537 Aux Id: [PR-9287]
