...
-doc """
Update agent config. This function,
[`update_agent_info/3`](`update_agent_info/3`), should be used when several
...
[](){: #update_usm_user_info } [](){: #update_usm_user_info1 }
""".
...
[](){: #which_usm_users } [](){: #which_usm_users0 }
""".
...
`m:snmpm_user` callback function [`handle_pdu`](`m:snmpm_user#handle_pdu`).
