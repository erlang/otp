...
[](){: #description } The module `snmp_generic` contains generic functions for
...
[](){: #variable_func22 } This is the default instrumentation function for
variables.
...
[](){: #variable_func23 } This is the default instrumentation function for
variables.
...
[](){: #variable_func32 } This is the default instrumentation function for
variables.

The function returns according to the specification of an instrumentation
function.

[](){: #variable_func33 } This is the default instrumentation function for
variables.
...
[](){: #get_table_info_2 } Get a specific table info item (defvals).

This function can be used in instrumentation functions to retrieve a given part
of the table info.

[](){: #get_table_info_3 } Get a specific table info item (status_col).

This function can be used in instrumentation functions to retrieve a given part
of the table info.

[](){: #get_table_info_4 } Get a specific table info item (not_accessible).

This function can be used in instrumentation functions to retrieve a given part
of the table info.

[](){: #get_table_info_5 } Get a specific table info item (index_types).

This function can be used in instrumentation functions to retrieve a given part
of the table info.

[](){: #get_table_info_6 } Get a specific table info item (first_accessible).

This function can be used in instrumentation functions to retrieve a given part
of the table info.

[](){: #get_table_info_7 } Get a specific table info item (first_own_index).

This function can be used in instrumentation functions to retrieve a given part
of the table info.

[](){: #get_table_info_8 } Get all table info item(s), a two tuple list
(property list) is returned with all the items and their respctive values of the
given table.
