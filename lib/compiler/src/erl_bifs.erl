...
is_pure(erlang, append_element, 2) -> true;
...
is_pure(erlang, delete_element, 2) -> true;
...
is_pure(erlang, insert_element, 3) -> true;
...
is_pure(erlang, make_tuple, 2) -> true;
is_pure(erlang, make_tuple, 3) -> true;
