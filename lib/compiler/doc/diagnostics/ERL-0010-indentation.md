...
indentation in triple-quoted string" or can "not white space after start
...
To fix this error, adhere to the EEP-64 formatting rules. The error messages
are often self-explanatory for this error.