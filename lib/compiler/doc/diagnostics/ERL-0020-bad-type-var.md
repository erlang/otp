...
the type variable is a valid Erlang variable in itself. For the example above, add underscore before the identifier to indicate that the type variable is not used, like this:
