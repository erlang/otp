...
TESTCASE(test_ei_encode_misc)
{
    ...
    EI_ENCODE_1(encode_atom, "≈ƒ÷Â‰ˆ");
    EI_ENCODE_2(encode_atom_len, "≈ƒ÷Â‰ˆ", 6);
    ...
    EI_ENCODE_1(encode_string, "≈ƒ÷Â‰ˆ");
    EI_ENCODE_2(encode_string_len, "≈ƒ÷Â‰ˆ", 6);

    EI_ENCODE_2(encode_binary, "foo", 3);
    EI_ENCODE_2(encode_binary, "", 0);
    EI_ENCODE_2(encode_binary, "≈ƒ÷Â‰ˆ", 6);
...
TESTCASE(test_ei_encode_utf8_atom_len)
{
  ...
  EI_ENCODE_4(encode_atom_len_as, "≈ƒ÷", 1, ERLANG_LATIN1, ERLANG_UTF8);
  EI_ENCODE_4(encode_atom_len_as, "≈ƒ÷", 2, ERLANG_LATIN1, ERLANG_LATIN1);
  ...
  EI_ENCODE_4_FAIL(encode_atom_len_as, "≈ƒ÷", 1, ERLANG_UTF8, ERLANG_UTF8);
  EI_ENCODE_4_FAIL(encode_atom_len_as, "≈ƒ÷", 2, ERLANG_UTF8, ERLANG_LATIN1);
  EI_ENCODE_4_FAIL(encode_atom_len_as, "≈ƒ÷", 3, ERLANG_ASCII, ERLANG_UTF8);
  EI_ENCODE_4_FAIL(encode_atom_len_as, "≈ƒ÷", 4, ERLANG_ASCII, ERLANG_LATIN1);
