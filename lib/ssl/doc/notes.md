...
- Handle ASN.1 decode errors in more places, to improve user error handling.
  ...
  Own Id: OTP-18969 Aux Id: [GH-8058]
...
- For security reasons remove CBC ciphers form default supported cipher suites in TLS-1.2

  *** POTENTIAL INCOMPATIBILITY ***

  Own Id: OTP-19025

- Add cert_policy_opts option to configure certificate policy options for the certificate path validation.
