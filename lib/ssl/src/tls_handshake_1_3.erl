...
calculate_handshake_secrets(PublicKey, PrivateKeyOrSecret, SelectedGroup, PSK,
    ...
    PendingRead1 = calculate_read_handsake_secrets(PublicKey, PrivateKeyOrSecret,
...
calculate_read_handsake_secrets(PublicKey, PrivateKeyOrSecret, SelectedGroup, PSK,
...
hs_secrets(Read, Write) ->
    {get_traffic_secret(client_handshake_traffic_secret, Read, Write),
     get_traffic_secret(server_handshake_traffic_secret, Read, Write)}.

get_traffic_secret(SecretType, Read, Write) ->
