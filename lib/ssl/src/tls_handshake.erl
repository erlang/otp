...
%%--------------------------------------------------------------------
ocsp_nonce(SslOpts) ->
    %% FIXME what should be the default for ocsp_nonce?
    OcspNonceOpt = case maps:get(ocsp_stapling, SslOpts, false) of
                       false ->
                           false;
                       OcspStaplingOpt ->
                           maps:get(ocsp_nonce, OcspStaplingOpt, false)
                   end,
    case OcspNonceOpt of
        true ->
