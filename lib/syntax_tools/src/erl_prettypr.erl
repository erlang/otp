...
lay_2(Node, Ctxt) ->
	...
	non_skipping_generator ->
	    Ctxt1 = reset_prec(Ctxt),
	    D1 = lay(erl_syntax:non_skipping_generator_pattern(Node), Ctxt1),
	    D2 = lay(erl_syntax:non_skipping_generator_body(Node), Ctxt1),
	    par([D1, beside(text("<-:- "), D2)], Ctxt1#ctxt.break_indent);
	...
	non_skipping_binary_generator ->
	    Ctxt1 = reset_prec(Ctxt),
	    D1 = lay(erl_syntax:non_skipping_binary_generator_pattern(Node), Ctxt1),
	    D2 = lay(erl_syntax:non_skipping_binary_generator_body(Node), Ctxt1),
	    par([D1, beside(text("<=:= "), D2)], Ctxt1#ctxt.break_indent);
	...
	non_skipping_map_generator ->
	    Ctxt1 = reset_prec(Ctxt),
	    D1 = lay(erl_syntax:non_skipping_map_generator_pattern(Node), Ctxt1),
	    D2 = lay(erl_syntax:non_skipping_map_generator_body(Node), Ctxt1),
	    par([D1, beside(text("<-:- "), D2)], Ctxt1#ctxt.break_indent);
