...
- **`timestamping_tx_sched`** - Request TX timestamps prior to entering the packet scheduler
- **`timestamping_tx_ack`** - Request TX timestamps when all data in the send buffer has been acknowledged
- **`timestamping_tx_completion`** - Request TX timestamps on packet TX completion
...
- **`timestamping_opt_id`** - Generate a unique identifier along with each packet
...
-type timestamping() ::
        ...
        timestamping_tx_sched |
        timestamping_tx_ack |
        timestamping_tx_completion |
