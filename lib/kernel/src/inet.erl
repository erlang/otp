...
A `string()` character list is the traditional form. *Since OTP @OTP-20357@*,
a `binary()` with the same character sequence is also accepted
(for example `~"192.168.0.1" = <<"192.168.0.1">>` and `"192.168.0.1"`).
""".
