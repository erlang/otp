...
wxWidgets docs:
[wxRadioBox](https://docs.wxwidgets.org/3.1/classwx_radio_box.html)
...
passing `wxNOT_FOUND` is not allowed.
""".
...
-doc """
Returns true if the item is currently shown or false if it was hidden using
`show/3`.
