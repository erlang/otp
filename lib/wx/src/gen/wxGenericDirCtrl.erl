...
wxWidgets docs:
[wxGenericDirCtrl](https://docs.wxwidgets.org/3.1/classwx_generic_dir_ctrl.html)
...
-export([collapseTree/1,create/2,create/3,destroy/1,expandPath/2,getDefaultPath/1,
  ...
  getTreeCtrl/1,init/1,new/0,new/1,new/2,reCreateTree/1,setDefaultPath/2,
  setFilter/2,setFilterIndex/2,setPath/2]).
...
getPath(#wx_ref{type=ThisT}=This,ItemId)
 when is_integer(ItemId) ->
  ?CLASS(ThisT,wxGenericDirCtrl),
  wxe_util:queue_cmd(This,ItemId,?get_env(),?wxGenericDirCtrl_GetPath_1),
