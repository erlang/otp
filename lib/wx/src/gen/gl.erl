...
stencilFuncSeparate(Frontfunc,Backfunc,Ref,Mask) ->
  cast(5443, <<Frontfunc:?GLenum,Backfunc:?GLenum,Ref:?GLint,Mask:?GLuint>>).
...
getUniformuiv(Program,Location) ->
  call(5545, <<Program:?GLuint,Location:?GLint>>).
...
bindFragDataLocation(Program,Color,Name) ->
  cast(5546, <<Program:?GLuint,Color:?GLuint,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 1) rem 8)) rem 8)>>).
...
getFragDataLocation(Program,Name) ->
  call(5547, <<Program:?GLuint,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 5) rem 8)) rem 8)>>).

%% @spec (Location::integer(),V0::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
-spec uniform1ui(integer(),integer()) -> ok.
uniform1ui(Location,V0) ->
  cast(5548, <<Location:?GLint,V0:?GLuint>>).

%% @spec (Location::integer(),V0::integer(),V1::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
-spec uniform2ui(integer(),integer(),integer()) -> ok.
uniform2ui(Location,V0,V1) ->
  cast(5549, <<Location:?GLint,V0:?GLuint,V1:?GLuint>>).

%% @spec (Location::integer(),V0::integer(),V1::integer(),V2::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
-spec uniform3ui(integer(),integer(),integer(),integer()) -> ok.
uniform3ui(Location,V0,V1,V2) ->
  cast(5550, <<Location:?GLint,V0:?GLuint,V1:?GLuint,V2:?GLuint>>).

%% @spec (Location::integer(),V0::integer(),V1::integer(),V2::integer(),V3::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
-spec uniform4ui(integer(),integer(),integer(),integer(),integer()) -> ok.
uniform4ui(Location,V0,V1,V2,V3) ->
  cast(5551, <<Location:?GLint,V0:?GLuint,V1:?GLuint,V2:?GLuint,V3:?GLuint>>).

%% @spec (Location::integer(),Value::[integer()]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
-spec uniform1uiv(integer(),[integer()]) -> ok.
uniform1uiv(Location,Value) ->
  cast(5552, <<Location:?GLint,(length(Value)):?GLuint,
...
uniform2uiv(Location,Value) ->
  cast(5553, <<Location:?GLint,(length(Value)):?GLuint,
...
uniform3uiv(Location,Value) ->
  cast(5554, <<Location:?GLint,(length(Value)):?GLuint,
...
uniform4uiv(Location,Value) ->
  cast(5555, <<Location:?GLint,(length(Value)):?GLuint,
...
texParameterIiv(Target,Pname,Params) ->
  cast(5556, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLint>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).
...
texParameterIuiv(Target,Pname,Params) ->
  cast(5557, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
...
clearBufferiv(Buffer,Drawbuffer,Value) ->
  cast(5560, <<Buffer:?GLenum,Drawbuffer:?GLint,(size(Value)):?GLuint,
...
clearBufferuiv(Buffer,Drawbuffer,Value) ->
  cast(5561, <<Buffer:?GLenum,Drawbuffer:?GLint,(size(Value)):?GLuint,
...
clearBufferfv(Buffer,Drawbuffer,Value) ->
  cast(5562, <<Buffer:?GLenum,Drawbuffer:?GLint,(size(Value)):?GLuint,
...
clearBufferfi(Buffer,Drawbuffer,Depth,Stencil) ->
  cast(5563, <<Buffer:?GLenum,Drawbuffer:?GLint,Depth:?GLfloat,Stencil:?GLint>>).

%% @spec (Name::enum(),Index::integer()) -> string()
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetString.xml">external</a> documentation.
-spec getStringi(enum(),integer()) -> string().
getStringi(Name,Index) ->
  call(5564, <<Name:?GLenum,Index:?GLuint>>).
...
loadTransposeMatrixfARB({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  cast(5582, <<M1:?GLfloat,M2:?GLfloat,M3:?GLfloat,M4:?GLfloat,M5:?GLfloat,M6:?GLfloat,M7:?GLfloat,M8:?GLfloat,M9:?GLfloat,M10:?GLfloat,M11:?GLfloat,M12:?GLfloat,M13:?GLfloat,M14:?GLfloat,M15:?GLfloat,M16:?GLfloat>>);
loadTransposeMatrixfARB({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12}) ->
  cast(5582, <<M1:?GLfloat,M2:?GLfloat,M3:?GLfloat,0:?GLfloat,M4:?GLfloat,M5:?GLfloat,M6:?GLfloat,0:?GLfloat,M7:?GLfloat,M8:?GLfloat,M9:?GLfloat,0:?GLfloat,M10:?GLfloat,M11:?GLfloat,M12:?GLfloat,1:?GLfloat>>).
...
loadTransposeMatrixdARB({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  cast(5583, <<M1:?GLdouble,M2:?GLdouble,M3:?GLdouble,M4:?GLdouble,M5:?GLdouble,M6:?GLdouble,M7:?GLdouble,M8:?GLdouble,M9:?GLdouble,M10:?GLdouble,M11:?GLdouble,M12:?GLdouble,M13:?GLdouble,M14:?GLdouble,M15:?GLdouble,M16:?GLdouble>>);
loadTransposeMatrixdARB({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12}) ->
  cast(5583, <<M1:?GLdouble,M2:?GLdouble,M3:?GLdouble,0:?GLdouble,M4:?GLdouble,M5:?GLdouble,M6:?GLdouble,0:?GLdouble,M7:?GLdouble,M8:?GLdouble,M9:?GLdouble,0:?GLdouble,M10:?GLdouble,M11:?GLdouble,M12:?GLdouble,1:?GLdouble>>).
...
multTransposeMatrixfARB({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  cast(5584, <<M1:?GLfloat,M2:?GLfloat,M3:?GLfloat,M4:?GLfloat,M5:?GLfloat,M6:?GLfloat,M7:?GLfloat,M8:?GLfloat,M9:?GLfloat,M10:?GLfloat,M11:?GLfloat,M12:?GLfloat,M13:?GLfloat,M14:?GLfloat,M15:?GLfloat,M16:?GLfloat>>);
multTransposeMatrixfARB({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12}) ->
  cast(5584, <<M1:?GLfloat,M2:?GLfloat,M3:?GLfloat,0:?GLfloat,M4:?GLfloat,M5:?GLfloat,M6:?GLfloat,0:?GLfloat,M7:?GLfloat,M8:?GLfloat,M9:?GLfloat,0:?GLfloat,M10:?GLfloat,M11:?GLfloat,M12:?GLfloat,1:?GLfloat>>).
...
multTransposeMatrixdARB({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  cast(5585, <<M1:?GLdouble,M2:?GLdouble,M3:?GLdouble,M4:?GLdouble,M5:?GLdouble,M6:?GLdouble,M7:?GLdouble,M8:?GLdouble,M9:?GLdouble,M10:?GLdouble,M11:?GLdouble,M12:?GLdouble,M13:?GLdouble,M14:?GLdouble,M15:?GLdouble,M16:?GLdouble>>);
multTransposeMatrixdARB({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12}) ->
  cast(5585, <<M1:?GLdouble,M2:?GLdouble,M3:?GLdouble,0:?GLdouble,M4:?GLdouble,M5:?GLdouble,M6:?GLdouble,0:?GLdouble,M7:?GLdouble,M8:?GLdouble,M9:?GLdouble,0:?GLdouble,M10:?GLdouble,M11:?GLdouble,M12:?GLdouble,1:?GLdouble>>).
...
weightbvARB(Weights) ->
  cast(5586, <<(length(Weights)):?GLuint,
...
weightsvARB(Weights) ->
  cast(5587, <<(length(Weights)):?GLuint,
...
weightivARB(Weights) ->
  cast(5588, <<(length(Weights)):?GLuint,
...
weightfvARB(Weights) ->
  cast(5589, <<(length(Weights)):?GLuint,
...
weightdvARB(Weights) ->
  cast(5590, <<(length(Weights)):?GLuint,0:32,
...
weightubvARB(Weights) ->
  cast(5591, <<(length(Weights)):?GLuint,
...
weightusvARB(Weights) ->
  cast(5592, <<(length(Weights)):?GLuint,
...
weightuivARB(Weights) ->
  cast(5593, <<(length(Weights)):?GLuint,
...
matrixIndexubvARB(Indices) ->
  cast(5596, <<(length(Indices)):?GLuint,
...
matrixIndexusvARB(Indices) ->
  cast(5597, <<(length(Indices)):?GLuint,
...
matrixIndexuivARB(Indices) ->
  cast(5598, <<(length(Indices)):?GLuint,
...
programStringARB(Target,Format,String) ->
  cast(5599, <<Target:?GLenum,Format:?GLenum,(list_to_binary([String|[0]]))/binary,0:((8-((length(String)+ 1) rem 8)) rem 8)>>).
...
bindProgramARB(Target,Program) ->
  cast(5600, <<Target:?GLenum,Program:?GLuint>>).
...
deleteProgramsARB(Programs) ->
  cast(5601, <<(length(Programs)):?GLuint,
...
programEnvParameter4dARB(Target,Index,X,Y,Z,W) ->
  cast(5603, <<Target:?GLenum,Index:?GLuint,X:?GLdouble,Y:?GLdouble,Z:?GLdouble,W:?GLdouble>>).
...
programEnvParameter4dvARB(Target,Index,{P1,P2,P3,P4}) ->
  cast(5604, <<Target:?GLenum,Index:?GLuint,P1:?GLdouble,P2:?GLdouble,P3:?GLdouble,P4:?GLdouble>>).

%% @spec (Target::enum(),Index::integer(),X::float(),Y::float(),Z::float(),W::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glProgramEnvParameterARB.xml">external</a> documentation.
-spec programEnvParameter4fARB(enum(),integer(),float(),float(),float(),float()) -> ok.
programEnvParameter4fARB(Target,Index,X,Y,Z,W) ->
  cast(5605, <<Target:?GLenum,Index:?GLuint,X:?GLfloat,Y:?GLfloat,Z:?GLfloat,W:?GLfloat>>).

%% @spec (Target::enum(),Index::integer(),Params::{float(),float(),float(),float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glProgramEnvParameterARB.xml">external</a> documentation.
-spec programEnvParameter4fvARB(enum(),integer(),{float(),float(),float(),float()}) -> ok.
programEnvParameter4fvARB(Target,Index,{P1,P2,P3,P4}) ->
  cast(5606, <<Target:?GLenum,Index:?GLuint,P1:?GLfloat,P2:?GLfloat,P3:?GLfloat,P4:?GLfloat>>).
...
programLocalParameter4dARB(Target,Index,X,Y,Z,W) ->
  cast(5607, <<Target:?GLenum,Index:?GLuint,X:?GLdouble,Y:?GLdouble,Z:?GLdouble,W:?GLdouble>>).
...
programLocalParameter4dvARB(Target,Index,{P1,P2,P3,P4}) ->
  cast(5608, <<Target:?GLenum,Index:?GLuint,P1:?GLdouble,P2:?GLdouble,P3:?GLdouble,P4:?GLdouble>>).

%% @spec (Target::enum(),Index::integer(),X::float(),Y::float(),Z::float(),W::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glProgramLocalParameterARB.xml">external</a> documentation.
-spec programLocalParameter4fARB(enum(),integer(),float(),float(),float(),float()) -> ok.
programLocalParameter4fARB(Target,Index,X,Y,Z,W) ->
  cast(5609, <<Target:?GLenum,Index:?GLuint,X:?GLfloat,Y:?GLfloat,Z:?GLfloat,W:?GLfloat>>).
...
programLocalParameter4fvARB(Target,Index,{P1,P2,P3,P4}) ->
  cast(5610, <<Target:?GLenum,Index:?GLuint,P1:?GLfloat,P2:?GLfloat,P3:?GLfloat,P4:?GLfloat>>).
...
getProgramStringARB(Target,Pname,String) ->
  send_bin(String),
  call(5615, <<Target:?GLenum,Pname:?GLenum>>).
...
detachObjectARB(ContainerObj,AttachedObj) ->
  cast(5618, <<ContainerObj:?GLhandleARB,AttachedObj:?GLhandleARB>>).
...
shaderSourceARB(ShaderObj,String) ->
 StringTemp = list_to_binary([[Str|[0]] || Str <- String ]),
  cast(5620, <<ShaderObj:?GLhandleARB,(length(String)):?GLuint,(size(StringTemp)):?GLuint,(StringTemp)/binary,0:((8-((size(StringTemp)+4) rem 8)) rem 8)>>).
...
compileShaderARB(ShaderObj) ->
  cast(5621, <<ShaderObj:?GLhandleARB>>).
...
attachObjectARB(ContainerObj,Obj) ->
  cast(5623, <<ContainerObj:?GLhandleARB,Obj:?GLhandleARB>>).
...
linkProgramARB(ProgramObj) ->
  cast(5624, <<ProgramObj:?GLhandleARB>>).
...
useProgramObjectARB(ProgramObj) ->
  cast(5625, <<ProgramObj:?GLhandleARB>>).
...
validateProgramARB(ProgramObj) ->
  cast(5626, <<ProgramObj:?GLhandleARB>>).
...
getInfoLogARB(Obj,MaxLength) ->
  call(5629, <<Obj:?GLhandleARB,MaxLength:?GLsizei>>).
...
getAttachedObjectsARB(ContainerObj,MaxCount) ->
  call(5630, <<ContainerObj:?GLhandleARB,MaxCount:?GLsizei>>).
...
getUniformLocationARB(ProgramObj,Name) ->
  call(5631, <<ProgramObj:?GLhandleARB,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 1) rem 8)) rem 8)>>).
...
getActiveUniformARB(ProgramObj,Index,MaxLength) ->
  call(5632, <<ProgramObj:?GLhandleARB,Index:?GLuint,MaxLength:?GLsizei>>).
...
getUniformfvARB(ProgramObj,Location) ->
  call(5633, <<ProgramObj:?GLhandleARB,Location:?GLint>>).
...
getUniformivARB(ProgramObj,Location) ->
  call(5634, <<ProgramObj:?GLhandleARB,Location:?GLint>>).
...
getShaderSourceARB(Obj,MaxLength) ->
  call(5635, <<Obj:?GLhandleARB,MaxLength:?GLsizei>>).
...
bindAttribLocationARB(ProgramObj,Index,Name) ->
  cast(5636, <<ProgramObj:?GLhandleARB,Index:?GLuint,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 5) rem 8)) rem 8)>>).
...
getActiveAttribARB(ProgramObj,Index,MaxLength) ->
  call(5637, <<ProgramObj:?GLhandleARB,Index:?GLuint,MaxLength:?GLsizei>>).
...
getAttribLocationARB(ProgramObj,Name) ->
  call(5638, <<ProgramObj:?GLhandleARB,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 1) rem 8)) rem 8)>>).
...
bindRenderbuffer(Target,Renderbuffer) ->
  cast(5640, <<Target:?GLenum,Renderbuffer:?GLuint>>).
...
deleteRenderbuffers(Renderbuffers) ->
  cast(5641, <<(length(Renderbuffers)):?GLuint,
...
renderbufferStorage(Target,Internalformat,Width,Height) ->
  cast(5643, <<Target:?GLenum,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei>>).
...
getRenderbufferParameteriv(Target,Pname) ->
  call(5644, <<Target:?GLenum,Pname:?GLenum>>).
...
bindFramebuffer(Target,Framebuffer) ->
  cast(5646, <<Target:?GLenum,Framebuffer:?GLuint>>).
...
deleteFramebuffers(Framebuffers) ->
  cast(5647, <<(length(Framebuffers)):?GLuint,
...
framebufferTexture1D(Target,Attachment,Textarget,Texture,Level) ->
  cast(5650, <<Target:?GLenum,Attachment:?GLenum,Textarget:?GLenum,Texture:?GLuint,Level:?GLint>>).
...
framebufferTexture2D(Target,Attachment,Textarget,Texture,Level) ->
  cast(5651, <<Target:?GLenum,Attachment:?GLenum,Textarget:?GLenum,Texture:?GLuint,Level:?GLint>>).
...
framebufferTexture3D(Target,Attachment,Textarget,Texture,Level,Zoffset) ->
  cast(5652, <<Target:?GLenum,Attachment:?GLenum,Textarget:?GLenum,Texture:?GLuint,Level:?GLint,Zoffset:?GLint>>).
...
framebufferRenderbuffer(Target,Attachment,Renderbuffertarget,Renderbuffer) ->
  cast(5653, <<Target:?GLenum,Attachment:?GLenum,Renderbuffertarget:?GLenum,Renderbuffer:?GLuint>>).
...
getFramebufferAttachmentParameteriv(Target,Attachment,Pname) ->
  call(5654, <<Target:?GLenum,Attachment:?GLenum,Pname:?GLenum>>).
...
blitFramebuffer(SrcX0,SrcY0,SrcX1,SrcY1,DstX0,DstY0,DstX1,DstY1,Mask,Filter) ->
  cast(5656, <<SrcX0:?GLint,SrcY0:?GLint,SrcX1:?GLint,SrcY1:?GLint,DstX0:?GLint,DstY0:?GLint,DstX1:?GLint,DstY1:?GLint,Mask:?GLbitfield,Filter:?GLenum>>).
...
renderbufferStorageMultisample(Target,Samples,Internalformat,Width,Height) ->
  cast(5657, <<Target:?GLenum,Samples:?GLsizei,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei>>).
...
framebufferTextureLayer(Target,Attachment,Texture,Level,Layer) ->
  cast(5658, <<Target:?GLenum,Attachment:?GLenum,Texture:?GLuint,Level:?GLint,Layer:?GLint>>).
...
-spec programParameteriARB(integer(),enum(),integer()) -> ok.
programParameteriARB(Program,Pname,Value) ->
  cast(5659, <<Program:?GLuint,Pname:?GLenum,Value:?GLint>>).
...
-spec framebufferTextureARB(enum(),enum(),integer(),integer()) -> ok.
framebufferTextureARB(Target,Attachment,Texture,Level) ->
  cast(5660, <<Target:?GLenum,Attachment:?GLenum,Texture:?GLuint,Level:?GLint>>).
...
framebufferTextureFaceARB(Target,Attachment,Texture,Level,Face) ->
  cast(5661, <<Target:?GLenum,Attachment:?GLenum,Texture:?GLuint,Level:?GLint,Face:?GLenum>>).
...
-spec vertexAttribDivisorARB(integer(),integer()) -> ok.
vertexAttribDivisorARB(Index,Divisor) ->
  cast(5662, <<Index:?GLuint,Divisor:?GLuint>>).
...
flushMappedBufferRange(Target,Offset,Length) ->
  cast(5663, <<Target:?GLenum,0:32,Offset:?GLintptr,Length:?GLsizeiptr>>).
...
deleteVertexArrays(Arrays) ->
  cast(5665, <<(length(Arrays)):?GLuint,
...
getUniformIndices(Program,UniformNames) ->
 UniformNamesTemp = list_to_binary([[Str|[0]] || Str <- UniformNames ]),
  call(5668, <<Program:?GLuint,(length(UniformNames)):?GLuint,(size(UniformNamesTemp)):?GLuint,(UniformNamesTemp)/binary,0:((8-((size(UniformNamesTemp)+0) rem 8)) rem 8)>>).
...
getActiveUniformsiv(Program,UniformIndices,Pname) ->
  call(5669, <<Program:?GLuint,(length(UniformIndices)):?GLuint,
...
getActiveUniformName(Program,UniformIndex,BufSize) ->
  call(5670, <<Program:?GLuint,UniformIndex:?GLuint,BufSize:?GLsizei>>).
...
getUniformBlockIndex(Program,UniformBlockName) ->
  call(5671, <<Program:?GLuint,(list_to_binary([UniformBlockName|[0]]))/binary,0:((8-((length(UniformBlockName)+ 5) rem 8)) rem 8)>>).
...
getActiveUniformBlockiv(Program,UniformBlockIndex,Pname,Params) ->
  send_bin(Params),
  call(5672, <<Program:?GLuint,UniformBlockIndex:?GLuint,Pname:?GLenum>>).
...
getActiveUniformBlockName(Program,UniformBlockIndex,BufSize) ->
  call(5673, <<Program:?GLuint,UniformBlockIndex:?GLuint,BufSize:?GLsizei>>).
...
uniformBlockBinding(Program,UniformBlockIndex,UniformBlockBinding) ->
  cast(5674, <<Program:?GLuint,UniformBlockIndex:?GLuint,UniformBlockBinding:?GLuint>>).
...
copyBufferSubData(ReadTarget,WriteTarget,ReadOffset,WriteOffset,Size) ->
  cast(5675, <<ReadTarget:?GLenum,WriteTarget:?GLenum,ReadOffset:?GLintptr,WriteOffset:?GLintptr,Size:?GLsizeiptr>>).
...
windowPos4dMESA(X,Y,Z,W) ->
  cast(5677, <<X:?GLdouble,Y:?GLdouble,Z:?GLdouble,W:?GLdouble>>).
...
windowPos4fMESA(X,Y,Z,W) ->
  cast(5678, <<X:?GLfloat,Y:?GLfloat,Z:?GLfloat,W:?GLfloat>>).
...
windowPos4iMESA(X,Y,Z,W) ->
  cast(5679, <<X:?GLint,Y:?GLint,Z:?GLint,W:?GLint>>).
...
windowPos4sMESA(X,Y,Z,W) ->
  cast(5680, <<X:?GLshort,Y:?GLshort,Z:?GLshort,W:?GLshort>>).
...
depthBoundsEXT(Zmin,Zmax) ->
  cast(5681, <<Zmin:?GLclampd,Zmax:?GLclampd>>).
...
stencilClearTagEXT(StencilTagBits,StencilClearTag) ->
  cast(5682, <<StencilTagBits:?GLsizei,StencilClearTag:?GLuint>>).
