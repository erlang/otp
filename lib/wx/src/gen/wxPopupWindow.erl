...
wxWidgets docs:
[wxPopupWindow](https://docs.wxwidgets.org/3.1/classwx_popup_window.html)
""".
-include("wxe.hrl").
...
-doc """
Move the popup window to the right position, i.e. such that it is entirely
visible.

The popup is positioned at ptOrigin + size if it opens below and to the right
(default), at ptOrigin - sizePopup if it opens above and to the left etc.
""".
