...
-export([addPage/3,addPage/4,advanceSelection/1,advanceSelection/2,cacheBestSize/2,
  ...
  getCurrentPage/1,getCursor/1,getDPI/1,getDropTarget/1,getEventHandler/1,
  ...
  hide/1,hitTest/2,inheritAttributes/1,initDialog/1,insertPage/4,insertPage/5,
  ...
  removeChild/2,removePage/2,reparent/2,screenToClient/1,screenToClient/2,
