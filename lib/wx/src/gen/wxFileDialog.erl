...
wxWidgets docs:
[wxFileDialog](https://docs.wxwidgets.org/3.1/classwx_file_dialog.html)
""".
-include("wxe.hrl").
...
style, use `getFilenames/1` instead.
""".
...
This function should only be used with the dialogs which have `wxFD_MULTIPLE`
style, use `getPath/1` for the others.
""".
...
-doc """
Sets the wildcard, which can contain multiple file types, for example: "BMP
