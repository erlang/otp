...
wxWidgets docs:
[wxListView](https://docs.wxwidgets.org/3.1/classwx_list_view.html)
""".
-include("wxe.hrl").
...
-doc """
Used together with `getFirstSelected/1` to iterate over all selected items in
the control.
