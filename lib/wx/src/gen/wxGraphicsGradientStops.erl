...
%% @doc See external documentation: <a href="http://www.wxwidgets.org/manuals/2.8.12/wx_wxgraphicsgradientstops.html">wxGraphicsGradientStops</a>.
%% @type wxGraphicsGradientStops().  An object reference, The representation is internal
