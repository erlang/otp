...
%%--------------------------------------------------------------------
openssl_cert_issuer_hash(Cert) when is_binary(Cert) ->
    OtpCert = pkix_decode_cert(Cert, otp),
    openssl_cert_issuer_hash(OtpCert);

openssl_cert_issuer_hash(#'OTPCertificate'{tbsCertificate = TBSCert}) ->
