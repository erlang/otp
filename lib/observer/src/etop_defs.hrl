...
-define(SYSFORM(IsTerminal, ShellMode),
	...
	" Load:  cpu  ~8w               Memory:  total    ~8w    binary   ~8w" ++ newline(IsTerminal, ShellMode) ++
	"        procs~8w                        processes~8w    code     ~8w" ++ newline(IsTerminal, ShellMode) ++
	"        runq ~8w                        atom     ~8w    ets      ~8w" ++ newline(IsTerminal, ShellMode)).
