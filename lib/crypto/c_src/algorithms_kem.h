...
void kem_add_algorithm(ErlNifEnv* env, const char* str_v3, unsigned unavailable, ERL_NIF_TERM atom);
...
struct kem_availability_t {
    const kem_probe_t* init = nullptr; // the pubkey_probe_t used to create this record
