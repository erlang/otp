...
init_per_testcase(remote_socket_close_high_load = Case, Config0) ->
    ...
    %% across different machines we try to use about 30% of free resources available
    %% on the system
    MaxConnectionsOpen = trunc((FreeMem div MEMORY_FOR_ONE_CONNECTION) * 0.3),
    ...
    [{max_connections_open, MaxConnectionsOpen} | Config];
