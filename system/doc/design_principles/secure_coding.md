...
* Inappropriate usage of functionality is not guaranteed to crash or produce
  ...
  Furthermore, using undocumented functionality, whether it is a function or an
  option, can result in almost anything happening.
...
[](){: #crypto-application }
### [`crypto`] Application
[`crypto` Application]: #crypto-application
...
[process dictionary] of currently executing process. This state could be
...
[](){: #ssh-application }
### [`ssh`] Application
[`ssh` Application]: #ssh-application
...
### [`public_key`] Application
[`public_key` Application]: #public_key-application
...
[](){: #xmerl-application }
### [`xmerl`] Application
[`xmerl` Application]: #xmerl-application
...
releases as well as CVEs affecting different OTP versions. Patches are
announced on the [`erlang-announce`] mailing list as well as on the
[erlang forums] web site.
...
[Legacy `crypto` Functions]: #user-content-legacy-crypto-functions
[process dictionary]: `e:system:ref_man_processes.html#process-dictionary`
[`public_key` Application]: #user-content-public_key-application
[Legacy `public_key` Functions]: #user-content-legacy-public_key-functions
...
[](){: #owasp-api1-2023 }
[API1:2023 Broken Object Level Authorization]: #owasp-api1-2023
   [](){: #owasp-api1-2023 }
