...
Erlang/OTP produces SLSA provenance starting with OTP-29.1. At this level, the provenance is:
...
- **Verifiable** — anyone can independently verify the provenance without
  trusting GitHub, using only the public Sigstore transparency log
  (Rekor).
...
Below we show how to verify the provenance for Erlang/OTP version `29.1` using
