...
#include "erl_zstd_errors.h" /* list of errors */
...
/*******************************************************************************
  ...
  `#define ZSTD_STATIC_LINKING_ONLY` before including erl_zstd.h.
 ...
 *  or a buffer with specified information (see erl_zdict.h).
