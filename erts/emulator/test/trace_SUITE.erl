...
system_monitor_args(Config) when is_list(Config) ->
    ...
    %%
    {'EXIT',{badarg,_}} = (catch erlang_system_monitor(atom)),
    {'EXIT',{badarg,_}} = (catch erlang_system_monitor({})),
    {'EXIT',{badarg,_}} = (catch erlang_system_monitor({1})),
    {'EXIT',{badarg,_}} = (catch erlang_system_monitor({1,2,3})),
    {'EXIT',{badarg,_}} = 
    (catch erlang_system_monitor({Self,atom})),
    {'EXIT',{badarg,_}} = 
    (catch erlang_system_monitor(atom, atom)),
    {'EXIT',{badarg,_}} = 
    (catch erlang_system_monitor({Self,[busy_port|busy_dist_port]})),
    {'EXIT',{badarg,_}} = 
    (catch erlang_system_monitor(Self, [{long_gc,-1}])),
    {'EXIT',{badarg,_}} = 
    (catch erlang_system_monitor({Self,[{long_gc,atom}]})),
    {'EXIT',{badarg,_}} = 
    (catch erlang_system_monitor(Self,[{large_heap,-1}])),
    {'EXIT',{badarg,_}} = 
    (catch erlang_system_monitor({Self,[{large_heap,atom}]})),
    {'EXIT',{badarg,_}} = 
        (catch erlang_system_monitor(Self,[{long_message_queue, {100,100}}])),
    {'EXIT',{badarg,_}} = 
        (catch erlang_system_monitor(Self,[{long_message_queue, {-1,1}}])),
    {'EXIT',{badarg,_}} = 
        (catch erlang_system_monitor(Self,[{long_message_queue, {0,-1}}])),
    {'EXIT',{badarg,_}} = 
        (catch erlang_system_monitor(Self,[{long_message_queue, {-1,0}}])),
    ok.
