...
struct erl_drv_entry ttsl_driver_entry = {
    .init = ttysl_init,
    .start = ttysl_start,
    .stop = IF_IMPL(ttysl_stop),
    .output = IF_IMPL(ttysl_from_erlang),
    .ready_input = IF_IMPL(ttysl_from_tty),
    .ready_output = IF_IMPL(ttysl_to_tty),
    .driver_name = "tty_sl",
    .finish = NULL,
    .handle = NULL,
    .control = IF_IMPL(ttysl_control),
    .timeout = NULL,
    .outputv = NULL,
    .ready_async = NULL,
    .flush = IF_IMPL(ttysl_flush_tty),
    .call = NULL,
    .event = NULL,
    ...
    .handle2 = NULL,
    .process_exit = NULL,
    .stop_select = IF_IMPL(ttysl_stop_select)
};
