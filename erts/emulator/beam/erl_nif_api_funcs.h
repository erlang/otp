...
ERL_NIF_API_FUNC_DECL(int, enif_term_to_binary_int, (ErlNifEnv *env, ERL_NIF_TERM term, ErlNifBinary *bin));
...
ERL_NIF_API_FUNC_DECL(size_t, enif_binary_to_term_int, (ErlNifEnv *env, const unsigned char* data, size_t sz, ERL_NIF_TERM *term, unsigned int opts));
