...
#define ERTS_ML_FLG_ALIAS_BIT1          (((Uint32) 1) << (ERTS_ML_F_BASE + 11))
#define ERTS_ML_FLG_ALIAS_BIT2          (((Uint32) 1) << (ERTS_ML_F_BASE + 12))
#define ERTS_ML_FLG_TAG                 (((Uint32) 1) << (ERTS_ML_F_BASE + 13))
#define ERTS_ML_FLG_PRIO_ML             (((Uint32) 1) << (ERTS_ML_F_BASE + 14))
#define ERTS_ML_FLG_PRIO_ALIAS          (((Uint32) 1) << (ERTS_ML_F_BASE + 15))
#define ERTS_ML_FLG_SPAWN_LINK_PRIO     (((Uint32) 1) << (ERTS_ML_F_BASE + 16))
