...
static int
write_f_add_cr(const void *vfp, const char* buf, size_t len)
{
    size_t i;
    ASSERT(vfp);
    for (i = 0; i < len; i++) {
...
static int
write_f(const void *vfp, const char* buf, size_t len)
{
    ASSERT(vfp);
...
static int
write_fd(const void *vfdp, const char* buf, size_t len)
{
    ssize_t size;
    size_t res = len;
    ASSERT(vfdp);
...
static int
write_s(const void *vwbufpp, const char* bufp, size_t len)
{
...
static int
write_sn(const void *vwsnap, const char* buf, size_t len)
{
    int rv = 0;
...
static int
write_ds(const void *vdsbufp, const char* buf, size_t len)
{
...
erts_fprintf(FILE *filep, const char *format, ...)
{
	...
	res = (*erts_printf_stderr_func)((char *) format, arglist);
        ...
        int (*fmt_f)(const void*, const char*, size_t);
...
erts_fdprintf(int fd, const char *format, ...)
{
    ...
    va_start(arglist, format);
    errno = 0;
    res = erts_printf_format(write_fd,
                             (const void *)&fd,
                             (const char *)format,
                             arglist);
    va_end(arglist);
...
erts_sprintf(char *buf, const char *format, ...)
{
    ...
    va_start(arglist, format);
    errno = 0;
    res = erts_printf_format(write_s,
                             (const void *) &p,
                             (const char *) format,
                             arglist);
    if (res < 0)
...
erts_snprintf(char *buf, size_t size, const char *format, ...)
{
    ...
    va_start(arglist, format);
    errno = 0;
    res = erts_printf_format(write_sn,
                             (const void *)&wsnap,
                             (const char *)format,
                             arglist);
    if (res < 0)
...
erts_dsprintf(erts_dsprintf_buf_t *dsbufp, const char *format, ...)
{
    ...
    va_start(arglist, format);
    errno = 0;
    res = erts_printf_format(write_ds,
                             (const void *)dsbufp,
                             (const char *)format,
                             arglist);
    if (dsbufp->str) {
